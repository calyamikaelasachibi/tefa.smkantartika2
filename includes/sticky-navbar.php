...
<div id="sticky-navbar" class="fixed top-0 left-0 w-full bg-white shadow-lg z-[1000] transform -translate-y-full opacity-0 invisible pointer-events-none hidden lg:block border-b border-gray-100">
    ...
    <div class="container mx-auto px-4">
        <div class="flex items-center justify-between gap-8 h-20">
            ...
            <nav class="flex items-center h-full space-x-1">
                <!-- Beranda -->
                <?php $is_index = ($halaman_sticky == 'index.php' || $halaman_sticky == ''); ?>
                <div class="group h-full flex items-center">
                    <a href="index.php" class="px-6 h-full flex items-center font-bold text-xs uppercase border-t-4 transition-all duration-200 relative 
                        <?= $is_index 
                            ? 'bg-[#002147] border-[#FFB606] text-white shadow-md' 
                            : 'border-transparent text-gray-700 hover:text-[#002147] hover:bg-gray-50' 
                        ?>">
                        Beranda
                    </a>
                ...
                <div class="group h-full flex items-center">
                    <a href="katalog.php" class="px-6 h-full flex items-center font-bold text-xs uppercase border-t-4 transition-all duration-200 relative 
                        <?= $is_katalog 
                            ? 'bg-[#002147] border-[#FFB606] text-white shadow-md' 
                            : 'border-transparent text-gray-700 hover:text-[#002147] hover:bg-gray-50' 
                        ?>">
                ...
                <div class="group h-full flex items-center">
                    <a href="tentang.php" class="px-6 h-full flex items-center font-bold text-xs uppercase border-t-4 transition-all duration-200 relative 
                        <?= $is_tentang 
                            ? 'bg-[#002147] border-[#FFB606] text-white shadow-md' 
                            : 'border-transparent text-gray-700 hover:text-[#002147] hover:bg-gray-50' 
                        ?>">
                ...
                <div class="group h-full flex items-center">
                    <a href="kontak.php" class="px-6 h-full flex items-center font-bold text-xs uppercase border-t-4 transition-all duration-200 relative 
                        <?= $is_kontak 
                            ? 'bg-[#002147] border-[#FFB606] text-white shadow-md' 
                            : 'border-transparent text-gray-700 hover:text-[#002147] hover:bg-gray-50' 
                        ?>">
